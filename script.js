...
function recalc() {
  ...
  if (fee > 0 && amt > 0) {
    calcRate.innerHTML = `Курс: 1 ${code} = ${formatVND(rate)} ₫ · <a href="https://telegram.me/vncash_danang" target="_blank" rel="noopener" style="color:#e11d48;text-decoration:underline">на маленькие суммы действует фикс. комиссия — уточнить в Telegram</a>`;
  } else if (bonus > 0) {
